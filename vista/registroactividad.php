<?php 
	...
	$conexion=mysqli_connect('localhost',"ascent","ascent123",'bdascent');
...
<div id="contenido">
        ...
        <div class= formatorow2>
                    ...
                    <div class=columinfo1>
                        ...
                        <?php 
		$sql="SELECT carrera as car FROM directorprograma WHERE correo='juan.carlos@uao.edu.co'";
	 ...
	 ?>
                    ...
                    <div class=columinfo1>
                        ...
                        <select class="labelestado" id="asignatu">
                            <option value="bioelem">BIOFÍSICA MÉDICA</option>
                    ...
                    <div class=columinfo1>
                        ...
                        <label class="labelestado" id="periodo">2022-1</label>
                    </div>
                    ...
                    <div class=columinfo1>
                        ...
                        <?php 
		                $sql="SELECT nombre , apellido  FROM USUARIO WHERE correo='juan.carlos@uao.edu.co'";
